    ...
    def solve(self):
        ...
        for epoch_count in range(self.args.num_epochs):
            ...
            for images, labels in self.train_data:
                ...
                if self.args.dataset == 'pathmnist' or self.args.dataset == 'tissuemnist' or self.args.dataset == \
                    'organamnist' or self.args.dataset == 'dermamnist' or self.args.dataset == 'octmnist' or \
                     self.args.dataset == 'bloodmnist' or self.args.dataset == 'organcmnist' \
                  or self.args.dataset == 'organsmnist' or self.args.dataset == 'retinamnist':
                     labels = labels.squeeze().long()
                     loss = self.ce_loss(preds, labels)
                elif self.args.dataset == 'pneumonia':
                    loss = self.ce_loss(preds, labels)


                elif self.args.dataset == 'chestmnist' or self.args.dataset == 'breastmnist':
                ...
                if num_iter % 200 == 0:
                    ...
                    print('iter num: {} \t loss: {:.2f} \t  Percentage: {}'.format(num_iter, loss.item(), percentage))
